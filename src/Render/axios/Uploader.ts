...
export default class FileProgressRequest {
  ...
  public upload(): this {
    ...
    axios
      ...
      .then((onfulfilled) => this._onSuccess && this._onSuccess(onfulfilled.data))
  ...
  public onSuccess<T extends { hasError?: boolean }>(callback?: (response: AxiosResponse<T>) => void): this {
